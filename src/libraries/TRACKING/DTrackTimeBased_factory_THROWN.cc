...
// BeginRun
//------------------
void DTrackTimeBased_factory_THROWN::BeginRun(const std::shared_ptr<const JEvent>& event)
{
...
// Process
//------------------
void DTrackTimeBased_factory_THROWN::Process(const std::shared_ptr<const JEvent>& event)
{
