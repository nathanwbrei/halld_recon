...
// BeginRun
//------------------
void DReaction_factory_B3pi_eff_missgamma::BeginRun(const std::shared_ptr<const JEvent> &locEvent)
{
...
// Process
//------------------
void DReaction_factory_B3pi_eff_missgamma::Process(const std::shared_ptr<const JEvent> &locEvent)
{
...
// Finish
//------------------
void DReaction_factory_B3pi_eff_missgamma::Finish()
{
